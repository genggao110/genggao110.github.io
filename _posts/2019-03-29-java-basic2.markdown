...
![Map集合](https://tva2.sinaimg.com/large/005CDUpdly1g1jhb3ta1aj30n60asq32.jpg)
...
![哈希表插入](https://tva2.sinaimg.com/large/005CDUpdgy1g61upgsbxmj30sg0i27dt.jpg)
...
```
![主要介绍](https://tva2.sinaimg.com/large/005CDUpdgy1g61uzg4mb9j30yg0f4gpz.jpg)
...
![存储流程](https://tva2.sinaimg.com/large/005CDUpdgy1g61vdntpt1j30fa0rs75a.jpg)

**数组元素、链表节点的实现类**

HashMap中的数组元素采用Entry静态内部类实现，如下所示：

![HashMap整体结构](https://tva2.sinaimg.com/large/005CDUpdgy1g61vh53b14j30sg0kok3m.jpg)
...
![参数示意图](https://tva2.sinaimg.com/large/005CDUpdgy1g61vzzwto9j30jg0a4wf4.jpg)

详细地介绍一下负载因子的使用建议：

![加载因子](https://tva2.sinaimg.com/large/005CDUpdgy1g61w13v0lcj30rz0indhg.jpg)

#### 4.源码分析

为了更具体的了解源码，从具体的使用步骤进行相关函数的详细分析，其主要内容如下所示：

![分析内容](https://tva2.sinaimg.com/large/005CDUpdgy1g61w3hhnz0j30ku0fvmzm.jpg)
...
![添加数据](https://tva2.sinaimg.com/large/005CDUpdgy1g61wfmfqwkj30fa0rs3zi.jpg)
...
![put流程](https://tva2.sinaimg.com/large/005CDUpdgy1g61wpej3yzj30yg0qdgnl.jpg)
...
![数组下标计算过程](https://tva2.sinaimg.com/large/005CDUpdgy1g61x91y901j30nm0b1dhh.jpg)
...
![原因描述](https://tva2.sinaimg.com/large/005CDUpdgy1g61xf1x8jhj30yg0asgp4.jpg)
...
![具体原因描述](https://tva2.sinaimg.com/large/005CDUpdgy1g61xifotumj30yg0hpdmt.jpg)
...
![原因描述](https://tva2.sinaimg.com/large/005CDUpdgy1g61xkuymsij30yg0cw0vm.jpg)
...
![替换流程](https://tva2.sinaimg.com/large/005CDUpdgy1g61xo1judsj30ji18vmza.jpg)

**key值的对比**

采用 equals（） 或 “==” 进行比较，下面给出其介绍 equals() 与 “==”使用的对比：

![key值比较](https://tva2.sinaimg.com/large/005CDUpdgy1g61xpimbdmj30y608ctah.jpg)
...
![键值对添加方式](https://tva2.sinaimg.com/large/005CDUpdgy1g62hz6ycr0j30ji18vwgt.jpg)

**扩容机制**

来看一下具体流程：

![扩容流程](https://tva2.sinaimg.com/large/005CDUpdly1g62i10umtdj30ee186tb1.jpg)

扩容过程中的转移数据示意图：

![数据转移](https://tva2.sinaimg.com/large/005CDUpdly1g62i20rijoj30wn23an2p.jpg)
...
![多线程HashMap的resize](https://tva2.sinaimg.com/large/005CDUpdgy1g62ie5fhigj312k0hgdhn.jpg)
...
![求余操作](https://tva2.sinaimg.com/large/005CDUpdgy1g62ij7trkyj30p20ek0ub.jpg)

还有，数组长度保持2的次幂，length-1的低位都为1，会使得获得的数组索引index更加均匀，比如：

![均匀](https://tva2.sinaimg.com/large/005CDUpdgy1g62ik8n4msj30r40cc75o.jpg)

我们看到，上面的&运算，高位是不会对结果产生影响的（hash函数采用各种位运算可能也是为了使得低位更加散列），我们只关注低位bit，如果低位全部为1，那么对于h低位部分来说，任何一位的变化都会对结果产生影响，也就是说，要得到index=21这个存储位置，h的低位只有这一种组合。这也是数组长度设计为必须为2的次幂的原因。

![非全1](https://tva2.sinaimg.com/large/005CDUpdgy1g62il31j2ej30r00d6dit.jpg)
...
![put全流程](https://tva2.sinaimg.com/large/005CDUpdgy1g62injydpij30yg139gp5.jpg)

示意图：

![示意图](https://tva2.sinaimg.com/large/005CDUpdgy1g62iodx8jxj30yg13qtdv.jpg)

**3. get()方法的解析**

给出get()方法的流程如下：

![get()](https://tva2.sinaimg.com/large/005CDUpdgy1g62iqb0g40j30hs0oqjst.jpg)
...
![数据结构](https://tva2.sinaimg.com/large/005CDUpdgy1g62j4hsuh6j30yg09i423.jpg)

**2.获取数据过程**

![数据获取过程](https://tva2.sinaimg.com/large/005CDUpdgy1g62j55qt3pj30x207swg7.jpg)

**3.扩容机制**

![扩容机制](https://tva2.sinaimg.com/large/005CDUpdgy1g62j8rmqoej30uk078gn2.jpg)

#### 6.关于HashMap的其他问题

**1. HashMap如何解决Hash冲突？**

![Hash冲突解决](https://tva2.sinaimg.com/large/005CDUpdgy1g62ja9taafj30yg0jbn1j.jpg)

**2. 为什么HashMap具备下述特点：键-值（key-value）都允许为空、线程不安全、不保证有序、存储位置随时间变化?**

![HashMap特点](https://tva2.sinaimg.com/large/005CDUpdgy1g62jbe1tzuj30wa0f8dh2.jpg)

**3.为什么 HashMap 中 String、Integer 这样的包装类适合作为 key 键？**

![HashMap键的选择](https://tva2.sinaimg.com/large/005CDUpdgy1g62jcirm7dj30yg0agjtj.jpg)

**4.HashMap 中的 key若 Object类型， 则需实现哪些方法？**

![Object类型](https://tva2.sinaimg.com/large/005CDUpdgy1g62jdkwoobj30yg0cntav.jpg)
...
![jdk1.8数据结构](https://tva2.sinaimg.com/large/005CDUpdly1g647z912bkj30lx0jzmxy.jpg)
...
![插入数据流程分析](https://tva2.sinaimg.com/large/005CDUpdgy1g77f575833j30sw19ajtm.jpg)
...
![扩容流程对比图](https://tva2.sinaimg.com/large/005CDUpdgy1g77fl5hgpgj30v41i6tf6.jpg)
...
![Entry结构手绘图](https://tva2.sinaimg.com/large/005CDUpdgy1g77ifuveclj30qk08o3yh.jpg)
...
![LinkedHashMap_base.png](https://tva2.sinaimg.com/large/005CDUpdly1g77ih0dapdj30xc0t6dip.jpg)
...
![LinkedHashMap_addEntry.png](https://tva2.sinaimg.com/large/005CDUpdgy1g77j0sp7wrj30xc0sygor.jpg)
...
![LinkedHashMap_removeEntryForKey.png](https://tva2.sinaimg.com/large/005CDUpdgy1g782r56owwj30xc0qtdix.jpg)
...
![数据结构](https://tva2.sinaimg.com/large/005CDUpdgy1g783zt2uifj318e0kqwja.jpg)

只不过LinkedHashMap 在上面结构的基础上，增加了一条双向链表，使得上面的结构可以保持键值对的插入顺序。同时通过对链表进行相应的操作，实现了访问顺序相关逻辑。其结构可能如下图：

![LinkedHashMap结构](https://tva2.sinaimg.com/large/005CDUpdgy1g7840okc5rj318g0l2afl.jpg)
...
![继承体系结构图](https://tva2.sinaimg.com/large/005CDUpdgy1g784r30ptpj318e0uegtl.jpg)
...
![插入操作过程](https://tva2.sinaimg.com/large/005CDUpdgy1g785mz13gbj318a0ly0yf.jpg)
...
![步骤1](https://tva2.sinaimg.com/large/005CDUpdgy1g7861yztyjj318g0l6ten.jpg)

根据hash定位到该节点属于3号桶，然后在对3号桶保存的单链表进行遍历，找到要删除的节点后，先从单链表中移除该节点。如下：

![步骤2](https://tva2.sinaimg.com/large/005CDUpdgy1g78644jkk5j318g0aqtbm.jpg)

然后再双向链表中移除该节点：

![步骤3](https://tva2.sinaimg.com/large/005CDUpdgy1g7864u9w8xj318e0lazpo.jpg)
...
![访问前结构](https://tva2.sinaimg.com/large/005CDUpdgy1g786kevd73j318g0l2afl.jpg)

访问后，键值为3的节点将会被移动到双向链表的最后位置，其前驱和后继也会跟着更新。访问后的结构如下：

![访问后结构](https://tva2.sinaimg.com/large/005CDUpdgy1g786l71jryj318k0ks79p.jpg)
...
![测试结果](https://tva2.sinaimg.com/large/005CDUpdgy1g786xxpiqdj30go05sq4a.jpg)
...
![HashMap1.7数据结构](https://tva2.sinaimg.com/large/005CDUpdgy1g7fi3ad66pj319g0kmgnn.jpg)
...
![ConcurrentHashMap数据结构](https://tva2.sinaimg.com/large/005CDUpdgy1g7fi68hqofj319g0wyn0o.jpg)
...
![ConcurrentHashMap 1.8数据结构](https://tva2.sinaimg.com/large/005CDUpdgy1g7fm4xm1c2j319g0k6myt.jpg)
...
![resizeStamp解析](https://tva2.sinaimg.com/large/005CDUpdgy1g7hbmduzkoj30mw0bkdg2.jpg)
...
![扩容SIZECTL值](https://tva2.sinaimg.com/large/005CDUpdgy1g7hbvdkgztj30eb090jrf.jpg)
...
![扩容过程](https://tva2.sinaimg.com/large/005CDUpdgy1g7hceetrs1j30s10dxdg5.jpg)
...
![转移数据流程](https://tva2.sinaimg.com/large/005CDUpdgy1g7hcj9ub3qj30qq0kndgr.jpg)
