...
其中，原子操作可以是一个步骤，也可以是多个操作步骤，但是其顺序不可以被打乱，也不可以被切割而只执行其中的一部分，将整个操作视作一个整体是原子性的核心特征。
...
![ABA示例](https://ws1.sinaimg.cn/large/005CDUpdgy1g76tvww3m7j30gw06aaa9.jpg)
...
![LongAdder原理](https://ws1.sinaimg.cn/large/005CDUpdgy1g7hrdrxwnej30i20ie3zq.jpg)
...
![cells数组大小](https://ws1.sinaimg.cn/large/005CDUpdgy1g7iysmteqej30io0i4myh.jpg)
